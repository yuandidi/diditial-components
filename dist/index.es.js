...
import React, { useState, useContext, forwardRef, useEffect, useRef, useReducer, createContext, useImperativeHandle } from 'react';
...
var Button = function (_a) {
    var _b;
    var _c = _a.btnType, btnType = _c === void 0 ? 'default' : _c, _d = _a.disabled, disabled = _d === void 0 ? false : _d, className = _a.className, size = _a.size, children = _a.children, href = _a.href, restProps = __rest(_a, ["btnType", "disabled", "className", "size", "children", "href"]);
...
var MenuContext = React.createContext({ index: '0' });
/**
 ...
 */
function Menu(_a) {
    var className = _a.className, _b = _a.mode, mode = _b === void 0 ? 'horizontal' : _b, style = _a.style, children = _a.children, _c = _a.defaultIndex, defaultIndex = _c === void 0 ? '0' : _c, _d = _a.defaultOpenSubMenus, defaultOpenSubMenus = _d === void 0 ? [] : _d, onSelect = _a.onSelect;
    var _e = useState(defaultIndex), currentActive = _e[0], setCurrentActive = _e[1];
    var classes = classNames('didi-menu', className, {
...
var Icon = function (props) {
    ...
    var classes = classNames('didi-icon', className, (_a = {},
...
function SubMenu(_a) {
    ...
    var isOpened = (index && context.mode === 'vertical') ? openedSubMenus === null || openedSubMenus === void 0 ? void 0 : openedSubMenus.includes(index) : false;
    ...
    var renderChildren = function () {
        var subMenuClasses = classNames('didi-submenu', {
...
var Input = forwardRef(function (_a, ref) {
    var _b;
    var disabled = _a.disabled, size = _a.size, icon = _a.icon, prepend = _a.prepend, append = _a.append, restProps = __rest(_a, ["disabled", "size", "icon", "prepend", "append"]);
    var classes = classNames('didi-input-wrapper', (_b = {},
    ...
    return (jsxs("div", __assign({ className: classes, "data-testid": "didi-input-wrapper" }, { children: [prepend && jsx("div", __assign({ className: "-didi-input-group-prepend" }, { children: prepend })), icon && jsx("div", __assign({ className: "icon-wrapper" }, { children: jsx(Icon, { icon: icon, title: "title-".concat(icon) }) })), jsx("input", __assign({ ref: ref, className: "didi-input-inner", disabled: disabled }, restProps)), append && jsx("div", __assign({ className: "input-group-append" }, { children: append }))] })));
});
...
var AutoComplete = function (_a) {
    var value = _a.value, fetchSuggestions = _a.fetchSuggestions, onSelect = _a.onSelect, renderOption = _a.renderOption, restProps = __rest(_a, ["value", "fetchSuggestions", "onSelect", "renderOption"]);
    ...
    var generateDropdown = function () {
        return (jsx("ul", __assign({ className: "didi-suggestion-list" }, { children: suggestions.map(function (item, index) {
                var cnames = classNames('suggestion-item', {
                    'is-active': index === highlightIndex
                });
                return (jsx("li", __assign({ role: "suggestion-item", className: cnames, onClick: function () { return handleSelect(item); } }, { children: renderTemplate(item) }), index));
            }) })));
    };
    return (jsxs("div", __assign({ className: "didi-auto-complete", ref: componentRef }, { children: [jsx(Input, __assign({ value: inputValue, onChange: handleChange, onKeyDown: handleKeyDown }, restProps)), loading && jsx("ul", { children: jsx(Icon, { icon: "spinner" }) }), suggestions.length > 0 && generateDropdown()] })));
};
...
var Progress = function (_a) {
    ...
    return (jsx("div", __assign({ className: "didi-progress-bar", style: styles }, { children: jsx("div", __assign({ className: "didi-progress-bar-outer", style: { height: "".concat(strokeHeight, "px") } }, { children: jsx("div", __assign({ className: "didi-progress-bar-inner color-".concat(theme), style: { width: "".concat(percent, "%") } }, { children: showText && jsx("span", __assign({ className: "inner-text" }, { children: "".concat(percent, "%") })) })) })) })));
};

var UploadList = function (_a) {
    var fileList = _a.fileList, onRemove = _a.onRemove;
    return (jsx("ul", __assign({ className: "didi-upload-list" }, { children: fileList.map(function (item) {
            return (jsxs("li", __assign({ className: "didi-upload-list-item" }, { children: [jsxs("span", __assign({ "data-testid": "file-name-".concat(item.status), className: "file-name file-name-".concat(item.status) }, { children: [jsx(Icon, { icon: "file-alt", theme: "secondary" }), item.name] })), jsxs("span", __assign({ className: "file-status" }, { children: [(item.status === 'uploading' || item.status === 'ready') && jsx(Icon, { icon: "spinner", spin: true, theme: "primary" }), item.status === 'success' && jsx(Icon, { icon: "check-circle", theme: "success" }), item.status === 'error' && jsx(Icon, { icon: "times-circle", theme: "danger" })] })), jsx("span", __assign({ className: "file-action" }, { children: jsx(Icon, { icon: "times", onClick: function () { onRemove(item); } }) })), item.status === 'uploading' && jsx(Progress, { percent: item.percent || 0 })] }), item.uid));
        }) })));
};
...
var Dragger = function (_a) {
    ...
    var klass = classNames('didi-uploader-dragger', {
...
var Upload = function (_a) {
    var action = _a.action, defaultFileList = _a.defaultFileList, onChange = _a.onChange, beforeUpload = _a.beforeUpload, onProgress = _a.onProgress, onSuccess = _a.onSuccess, onError = _a.onError, onRemove = _a.onRemove, headers = _a.headers, _b = _a.name, name = _b === void 0 ? 'file' : _b, data = _a.data, withCredentials = _a.withCredentials, accept = _a.accept, multiple = _a.multiple, children = _a.children, drag = _a.drag;
    ...
    var post = function (file) {
        ...
        axios.post(action, formData, {
            ...
            onUploadProgress: function (e) {
                var percentage = e.total ? Math.round((e.loaded * 100) / e.total) || 0 : 0;
                if (percentage < 100) {
    ...
    return (jsxs("div", __assign({ className: "didi-upload-component" }, { children: [jsx("div", __assign({ className: "didi-upload-input", style: { display: 'inline-block' }, onClick: handleClick }, { children: drag ?
                    jsx(Dragger, __assign({ onFile: function (files) { uploadFiles(files); } }, { children: children })) :
                    children })), jsx("input", { className: "didi-file-input", "data-testid": "didi-file-input", style: { display: 'none' }, type: "file", ref: fileInput, onChange: handleFileChange, accept: accept, multiple: multiple }), jsx(UploadList, { fileList: fileList, onRemove: handleRemove })] })));
};
...
var Tabs = function (_a) {
    var _b = _a.defaultIndex, defaultIndex = _b === void 0 ? 0 : _b, className = _a.className, onSelect = _a.onSelect, _c = _a.type, type = _c === void 0 ? 'line' : _c, children = _a.children;
    var _d = useState(defaultIndex), activeIndex = _d[0], setActiveIndex = _d[1];
    var handleClick = function (e, disabled, index) {
        if (!disabled) {
    ...
    var navClasses = classNames('didi-tabs-nav', {
        'nav-line': type === 'line',
        'nav-card': type === 'card'
    });
    var renderNavLinks = function () {
        return React.Children.map(children, function (child, index) {
            ...
            var classes = classNames('didi-tabs-nav-item', {
                'is-active': activeIndex === index,
                'is-disabled': disabled
            });
            return (jsx("li", __assign({ className: classes, onClick: function (e) { return handleClick(e, disabled, index); } }, { children: label }), "nav-item-".concat(index)));
        });
    };
    ...
    return (jsxs("div", __assign({ className: "didi-tabs ".concat(className) }, { children: [jsx("ul", __assign({ className: navClasses, "data-testid": "didi-tabs-nav" }, { children: renderNavLinks() })), jsx("div", __assign({ className: "didi-tabs-content" }, { children: renderContent() }))] })));
};

var TabItem = function (_a) {
    var children = _a.children;
    return jsx("div", __assign({ className: "didi-tab-panel" }, { children: children }));
};
...
var Alert = function (_a) {
    var _b;
    var title = _a.title, description = _a.description, _c = _a.type, type = _c === void 0 ? 'default' : _c, onClose = _a.onClose, _d = _a.closable, closable = _d === void 0 ? true : _d;
    var _e = useState(false), hide = _e[0], setHide = _e[1];
    var cnames = classNames('didi-alert', (_b = {},
        _b["didi-alert-".concat(type)] = type,
        _b));
    ...
    return (jsx(Transition, __assign({ in: !hide, timeout: 300, animation: "zoom-in-top", unmountOnExit: true }, { children: jsxs("div", __assign({ className: cnames, "data-testid": "didi-alert" }, { children: [jsx("span", __assign({ className: "bold-title" }, { children: title })), description && jsx("p", __assign({ className: "didi-alert-desc" }, { children: description })), closable && jsx("span", __assign({ className: "didi-alert-close", onClick: handleClose }, { children: jsx(Icon, { icon: "times" }) }))] })) })));
};

var SelectContext = React.createContext({ selectedValues: [] });
/**
 * 下拉选择器。
...
var Select = function (_a) {
    var defaultValue = _a.defaultValue, _b = _a.placeholder, placeholder = _b === void 0 ? '请选择' : _b, disabled = _a.disabled, _c = _a.name, name = _c === void 0 ? 'didi-select' : _c, onChange = _a.onChange, children = _a.children, multiple = _a.multiple, onVisibleChange = _a.onVisibleChange;
    var _d = useState(defaultValue ? defaultValue : ''), value = _d[0], setValue = _d[1];
    ...
    var containerClass = classNames('didi-select', {
    ...
    var handleOptionClick = function (e, optionValue) {
        e.preventDefault();
        e.stopPropagation();
        if (!multiple) {
            setMenuOpen(!menuOpen);
        ...
        var updatedValue = [optionValue];
        if (multiple) {
            setValue('');
            if (selectedValues.includes(optionValue)) {
                updatedValue = selectedValues.filter(function (value) { return value !== optionValue; });
                setSelectedValues(updatedValue);
            }
            else {
                updatedValue = __spreadArray(__spreadArray([], selectedValues, true), [optionValue], false);
                setSelectedValues(updatedValue);
            }
        }
        if (onChange) {
    ...
    return (jsxs("div", __assign({ className: containerClass, ref: containerRef }, { children: [jsx("div", __assign({ className: "didi-select-input", onClick: handleClick }, { children: jsx(Input, { ref: input, placeholder: placeholder, name: name, icon: "angle-down", readOnly: true, value: value }) })), jsx(SelectContext.Provider, __assign({ value: passContext }, { children: jsx(Transition, __assign({ in: menuOpen, timeout: 300, animation: "zoom-in-top" }, { children: jsx("ul", __assign({ className: "didi-select-dropdown" }, { children: renderOption() })) })) })), jsx("div", __assign({ className: "didi-selected-tags", style: { maxWidth: containerWidth.current - 32 } }, { children: multiple &&
                    selectedValues.map(function (value, index) {
                        return (jsxs("span", __assign({ "data-testid": "didi-tag", className: "didi-tag", onClick: function (e) { return handleOptionClick(e, value); } }, { children: [value, jsx(Icon, { icon: "times" })] }), "tag-".concat(index)));
                    }) }))] })));
};

var Option = function (_a) {
    var index = _a.index, value = _a.value, label = _a.label, disabled = _a.disabled, children = _a.children;
    var _b = useContext(SelectContext), onSelect = _b.onSelect, selectedValues = _b.selectedValues;
    var isSelected = selectedValues.includes(value);
    var classes = classNames('didi-select-item', {
        'is-disabled': disabled,
    ...
    return (jsxs("li", __assign({ className: classes, onClick: function (e) { return handleClick(e, value); } }, { children: [label || children || value, isSelected && jsx("span", { children: jsx(Icon, { icon: "check" }) })] }), index));
};
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    isValid = false;
                    err = e_2;
                    console.log('validateAllFields', e_2);
                    errors = err.fields;
                    ...
                    return [3 /*break*/, 5];
                case 4:
                    setForm(__assign(__assign({}, form), { isValid: isValid, isSubmitting: false, errors: errors }));
                    return [2 /*return*/, {
                            isValid: isValid,
                            errors: errors,
                            values: valueMap
...
var Form = forwardRef(function (_a, ref) {
    var _b = _a.name, name = _b === void 0 ? 'didi-form' : _b, children = _a.children, initialValues = _a.initialValues, onFinish = _a.onFinish, onFinishFailed = _a.onFinishFailed;
    ...
    return (jsx(Fragment, { children: jsx("form", __assign({ name: name, className: "didi-form", onSubmit: submitForm }, { children: jsx(FormContext.Provider, __assign({ value: passedContext }, { children: childrenNode })) })) }));
});
...
var FormItem = function (_a) {
    ...
    var rowClass = classNames('didi-row', {
    ...
    var itemClass = classNames('didi-form-item-control', {
    ...
    return (jsxs("div", __assign({ className: rowClass }, { children: [label &&
                jsx("div", __assign({ className: 'didi-form-item-label' }, { children: jsx("label", __assign({ title: label, className: labelClass }, { children: label })) })), jsxs("div", __assign({ className: "didi-form-item" }, { children: [jsx("div", __assign({ className: itemClass }, { children: returnChildNode })), hasError &&
                        jsx("div", __assign({ className: 'didi-form-item-explain' }, { children: jsx("span", { children: errors[0].message }) }))] }))] })));
};
